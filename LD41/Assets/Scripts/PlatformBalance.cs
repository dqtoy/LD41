...
*/
		...
		*/
        ...
        Vector3 targetPosition = new Vector3(transform.position.x, p1.y, transform.position.z);
        Vector3 direction = (targetPosition - transform.position).normalized;
        float distance = Vector3.Distance(targetPosition, transform.position);
        float moveOffset = Mathf.Min(moveSpeed * Time.deltaTime, distance);
        Vector3 movementDelta = direction * moveOffset;
