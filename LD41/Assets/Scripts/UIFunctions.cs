...
public class UIFunctions : SingletonBehaviour<UIFunctions> {
	...
	public void PlayGame()
	{
        ...
        gameStarted = true; 
        MusicManager.Instance.PlaySong(0, 3);
        PostProcessingManager.Instance.SpecialDOFEffect();
        BulletHellManager.Instance.StartDestroying();
        AudioManager.Instance.PlayBombBG();
        CGManager.Instance.PlayCG();
	}
